...
export const VaultsPage: FunctionalComponent<{ state: PrivilegedState }> = ({ state }) => {
    ...
    const createVaultError = creatingVault.lastError && <Status level="danger" colorText={true}>{creatingVault.lastError.toString()}</Status>
